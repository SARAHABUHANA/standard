  ...
  return (
    <footer style={{
      ...
      <div style={{ maxWidth: '100%', margin: 'auto', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
        <div className='text-footer' style={{marginLeft:"50px",marginTop:"5px",fontSize:"15px",fontFamily:"cursive", display: 'flex', justifyContent: 'space-between' }}>
...
<p><IoLocationSharp /> Address: Tech Innovate</p>
        ...
        <div className='Icon-footer' style={{display:"flex",
          ...
          <a className='F' href="#" style={{marginLeft:"30px",marginTop:"5px",padding:"5px", fontSize:"30px" ,color:"#c22137", ":hover": {
